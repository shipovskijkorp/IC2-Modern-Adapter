...
/** Fabric 1.21.1 registration and interaction glue for the loader-neutral Generator. */
public final class GeneratorPlatform {
    ...
    public static void register() {
        generatorMenu = Registry.register(
                ...
                ResourceLocation.fromNamespaceAndPath(IC2ModernAdapter.MOD_ID, "generator"),

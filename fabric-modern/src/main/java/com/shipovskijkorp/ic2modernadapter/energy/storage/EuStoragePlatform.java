...
/** Fabric 1.21.1 registration and interaction glue for IC2 electric storage blocks. */
public final class EuStoragePlatform {
    ...
    public static void register() {
        storageMenu = Registry.register(
                ...
                ResourceLocation.fromNamespaceAndPath(IC2ModernAdapter.MOD_ID, "eu_storage"),

...
public final class MachineClientRegistration {
    ...
    public static void onRegisterScreens(RegisterMenuScreensEvent event) {
        ...
        event.register(MachinePlatform.menuType(MachineSpec.CANNER), CannerScreen::new);
        event.register(MachinePlatform.menuType(MachineSpec.SOLID_CANNER), SolidCannerScreen::new);

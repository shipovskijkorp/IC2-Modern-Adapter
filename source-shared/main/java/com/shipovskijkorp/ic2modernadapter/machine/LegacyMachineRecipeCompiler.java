...
public final class LegacyMachineRecipeCompiler {
    ...
    public static final String EXTRACTOR_INI = "config/extractor.ini";
    ...
    public static final String THERMAL_CENTRIFUGE_INI = "config/thermal_centrifuge.ini";
    public static final int EXPECTED_MACERATOR = 89;
    public static final int EXPECTED_COMPRESSOR = 51;
    public static final int EXPECTED_EXTRACTOR = 14;
    ...
    public static final int EXPECTED_THERMAL_CENTRIFUGE = 26;
    ...
    public static Result compile(OriginalIc2Archive archive) throws IOException {
        ...
        List<LegacyMachineRecipeDefinition> extractor = LegacyMachineRecipeParser.parse(
                MachineSpec.EXTRACTOR, "extractor.ini", archive.readAsset(EXTRACTOR_INI));
        ...
        List<LegacyMachineRecipeDefinition> thermalCentrifuge = LegacyMachineRecipeParser.parse(
                MachineSpec.THERMAL_CENTRIFUGE,
                "thermal_centrifuge.ini",
                archive.readAsset(THERMAL_CENTRIFUGE_INI),
                false,
                true);
        if (macerator.size() != EXPECTED_MACERATOR
                || compressor.size() != EXPECTED_COMPRESSOR
                || extractor.size() != EXPECTED_EXTRACTOR
                ...
                || thermalCentrifuge.size() != EXPECTED_THERMAL_CENTRIFUGE) {
            throw new IOException("Unexpected IC2 2.8.222 machine recipe surface: macerator="
                    ...
                    + ", thermalCentrifuge=" + thermalCentrifuge.size());
        }
